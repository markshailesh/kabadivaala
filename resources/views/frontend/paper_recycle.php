             ...
             <div class="row">
                 <div class="col-lg-12">
                     <div class="breadcroumb-title text-center">
                         ...
                         <h6><a href="index.html">Home</a> / Paper Recycling</h6>
                     </div>
                 </div>
             </div>
         </div>
                     ...
                     <div class="service-details_sidebar">
                         <div class="service-details_sidebar-service">
                             <ul class="service-details_sidebar-service-list list-unstyled">
                                 <li class="d-block current"><a href="paper_recycle.html">Paper Recycling <span> <i class="las la-long-arrow-alt-right"></i></span></a></li>
                 ...
                 <div class="col-xl-8 col-lg-7">
                     <div class="service-details_right">
                         <div class="service-details_img">
                             <img src="assets/img/service-details/paper_recycle.jpg" alt="">
