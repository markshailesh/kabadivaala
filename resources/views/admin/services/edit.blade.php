            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-content">
                        <form action="{{ route('admin.services.update', $service->id) }}" method="POST" id="update_form"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                            placeholder="Enter Title..." value="{{ $service->name }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input id="inputGroupFile01" type="file" name="image"
                                                class="custom-file-input" value="{{ $service->image }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="short_desc" value="{{ $service->short_desc }}"
                                            class="form-control" placeholder="Enter Short Desc..." required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
